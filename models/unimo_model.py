...
class UnimoModelF(nn.Module):
    def __init__(self, args, vision_config, text_config):
        ...
        self.fc = nn.Linear(self.text_config.hidden_size, 2)

        self.CE_Loss = CrossEntropyLoss()

    def forward(self, input_ids, attention_mask, token_type_ids, labels, images):
        output, cl_loss, js_loss = self.model(input_ids=input_ids,
        ...
        loss = self.CE_Loss(final_output, labels.long()) + cl_loss + js_loss
